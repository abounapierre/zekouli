...
public class CycleController extends AbstractController {
	...
	public String showUpdateForm(@PathVariable("id") Long id, Model model) {
		CycleModel cycleModel = service.obtenirParId(id);
		if (cycleModel != null) {
